...
function () {
  ...
  _createClass(Mention, [{
    ...
    value: function insertItem(data) {
      ...
      this.quill.insertText(prevMentionCharPos, render.id, Quill.sources.USER);

      if (this.options.spaceAfterInsert) {
        this.quill.insertText(prevMentionCharPos + render.id.length + 1, "", Quill.sources.USER); // setSelection here sets cursor position
    ...
    value: function setMentionContainerPosition() {
      ...
      var rect = this.mentionContainer.getBoundingClientRect();
      var x = rect.left + rect.width;
      var x1 = containerPos.left + containerPos.width;
      var left = 0;
